...
class Verifyreportesacu extends CI_Controller {
 ...
 function __construct()
 {
  ...
  public function pagination() {
    ...
    //Go to private area          
    $config = array();
    $config["base_url"] = base_url() . "index.php/verifyreportesacu/pagination";
    $config["total_rows"] = $this->reportes->consultarNumDatos_acu($inicio, $fin);
    $config["per_page"] = 20;
    ...
    $data = array('nombre'=> $session_data['nombre']);
    $data["results"] = $this->reportes->consultar_datos_acu($inicio, $fin,$config["per_page"], $page);
    $data["links"] = $this->pagination->create_links();

    $this->load->view("reportes_acuconsulta_view", $data);
  }
  //////////////////////////////////////////////////////////////
  ...
  {    
    ...
    $delimiter = ",";
    $newline = "\r\n";
    $query = $this->reportes->get_datosconsulta_acu($inicio, $fin);    
