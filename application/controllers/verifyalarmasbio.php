...
class Verifyalarmasbio extends CI_Controller {
 ...
 function index()
 {
    if($this->session->userdata('logged_in'))
     ...
     else
     {
      ...
      $data1 = array('nombre'=> $session_data['nombre'] ,'result' => $this->alarmas->consultar_alarmas_bio($inicio, $fin));           
      $this->load->view('alarmas_rangosbio_view', $data1);    
 ...
 function check_database($to)
 {
   ...
   $result = $this->alarmas->consultar_alarmas_bio($from, $to);
