...
<html>	
	...
	<body>
		<div class="container">
		    ...
		    <div class="row fondo">
		    <h3>Eólico</h3>		    			    						    		    						    		    
				<h4>Alarmas voltaje al día</h4>						      			             		  	
			    <?php 
			    if ($alarmasdiavol == 0) {
			    	echo "Sin alarmas en Voltaje";
			    }
			    else{
				    foreach ($alarmasdiavol as $advo) {				 			    					    
					    ?> 	
						    <div class="alert">
			    ...
			    if ($alarmasdiavi == 0) {
				    ...
				    foreach ($alarmasdiavi as $advi) {				    					    					    
					    ?> 	
						    <div class="alert">
							    <button type="button" class="close" data-dismiss="alert">&times;</button>
							    <strong>Advertencia!</strong>			      
						      		<?php echo $advi->fecha_hora.','.$advi->velocidad_viento ?>
						  	</div>			      
					    <?php 												
		    		}
	    		}	    		
			...
			<?php echo form_open('verifyalarmaseo'); ?>
			...
			<?php echo form_close(); ?>
			<hr>
			<a class="btn btn-large btn-primary" href="<?php echo site_url('eolico') ?>"><i class="icon-arrow-left icon-white"></i> Regresar</a>
			</div>			
	<div class="container">
		<div class="row">				
