	...
	<body>
		<div class="container">
		    ...
		    <div class="row fondo">	
				...
				<h4>Alarmas del día</h4>				
		      
			    <!--Se recorre el arreglo datoscal que se recibio y se muestran las alarmas   -->              		  			
			    <?php 
			    if ($alarmasdia == 0) {
			    	echo "No hay alarmas actualmente";
			    }
			    else{
				    foreach ($alarmasdia as $ad) {
				    	if ($ad->temp_tuberia_1 <= 50) {				    					    	
					    ?> 	
						    <div class="alert">
							    <button type="button" class="close" data-dismiss="alert">&times;</button>
							    <strong>Advertencia!</strong>			      
						      		<?php echo $ad->fecha_hora.'='.$ad->temp_tuberia_1 ?>
						  	</div>			      
					    <?php 
						}	
						else{
			...
			<?php echo form_open('verifyalarmascs'); ?>
