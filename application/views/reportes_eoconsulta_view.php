...
<html>	
	...
	<body>
		<div class="container">
		    ...
		    <div class="row fondo">
		    	<h3>Eólico</h3>	
		    	<a class="btn btn-large" href="<?php echo site_url('verifyreporteseo/exportar_csv_consulta') ?>"><i class="icon-download"></i> Exportar</a>   			    						    		    						    		    		    	
				<hr>
		    	<table class="table">
				<tr>
				    <th>Fecha</th>
				    <th>Veolicidad del viento</th>
				    <th>Voltaje</th>
				    <th>Potencia</th>
				    <th>rpm</th>
				</tr>
				...
				if ($results == 0) {
					...
					<tr>
					    ...
					    <td><?php echo $data->velocidad_viento; ?></td>
					    <td><?php echo $data->voltaje; ?></td>
					    <td><?php echo $data->potencia; ?></td>
					    <td><?php echo $data->rpm; ?></td>
					</tr>
				...
				<p><?php echo $links; ?></p>
			<hr>		
			<a class="btn btn-large btn-primary" href="<?php echo site_url('reportesEolico') ?>"><i class="icon-arrow-left icon-white"></i> Regresar</a>
			</div>			
	<div class="container">
		<div class="row">				
