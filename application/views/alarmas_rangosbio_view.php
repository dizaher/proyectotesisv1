	...
	<body>
		<div class="container">
		    ...
		    <h3>Biodiesel</h3>	    			    						    		    						    		    
					    ...
					    ?> 	
						    <div class="alert">
							    ...
							    <strong>Advertencia!</strong>			      
						      		<?php echo $ar->fecha_hora.'='.$ar->sensor_temp_reactor ?>
						  	</div>			      
					    <?php 				
		    		}
	    		}	    		
	    		?>
	    	<hr>	    	
			<a class="btn btn-large btn-primary" href="<?php echo site_url('alarmas_biodiesel') ?>"><i class="icon-arrow-left icon-white"></i> Regresar</a>
			</div>			
	<div class="container">
		<div class="row">				
