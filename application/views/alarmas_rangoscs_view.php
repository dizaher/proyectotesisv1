	...
	<body>
		<div class="container">
		    ...
		    <div class="row fondo">	
				...
				<h4>Alarmas por rangos de fechas</h4>	
				<!--Se recorre el arreglo datoscal que se recibio y se muestran las alarmas   -->              		  			
			    <?php 
			    if ($result == 0) {
			    	echo "No hay alarmas en el rango seleccionado";
			    }
			    else{
				    foreach ($result as $ar) {
				    	if ($ar->temp_tuberia_1 <= 50) {				    					    	
					    ?> 	
						    <div class="alert">
							    <button type="button" class="close" data-dismiss="alert">&times;</button>
							    <strong>Advertencia!</strong>			      
						      		<?php echo $ar->fecha_hora.'='.$ar->temp_tuberia_1 ?>
						  	</div>			      
					    <?php 
						}	
						else{
	    		...
	    		?>
	    	<hr>	    	
			<a class="btn btn-large btn-primary" href="<?php echo site_url('alarmas_calentador') ?>"><i class="icon-arrow-left icon-white"></i> Regresar</a>
			</div>			
	<div class="container">
		<div class="row">				
