...
<html>	
	...
	<body>
		<div class="container">
		    ...
		    <h3>Acuaponia</h3>
		    <div class="row fondo">		 
		    	<a class="btn btn-large" href="<?php echo site_url('reportesAcuaponia/pagination') ?>"><i class="icon-list-alt"></i> Consultar Todos</a>   			    						    		    						    		    		    	
			<hr>
	    	<h4>Selecciona el rango de fechas para tu reporte</h4>		    	
			<?php echo form_open('verifyreportesacu'); ?>
